...
def make_grayscale(input_image):
    ...
    decode_image = cv2.imdecode(image_array,cv2.IMREAD_UNCHANGED)
    print("decoded image: ",decode_image)

    converted_gray_image = cv2.cvtColor(decode_image, cv2.COLOR_RGB2GRAY)
